...
<!-- $conn = mysqli_connect("35.224.164.95", "root", "navin1234","count") or die ("error".mysqli_error()); -->
      ...
      <div class="container-fluid">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">                                                                           3090                    </div>
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">This month's visitors</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800"> 3294                    </div>
          ...
          <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                  <span class="mr-2">
                    <i class="fas fa-circle text-primary"></i> Total: 20,000                 </span>
                </div>
              </div>
            </div>
          </div>
        ...
        <form action="">
        Select Month:
        <input type="month" name="datepicker">
        <input type="submit">
        </form>
        </div>
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800"> 27 : 18 Visitors  </div>
                  </div>
                  <div class="col-auto">
                    <a href="#average"><i class="fas fa-walking fa-2x text-gray-300"></i></a>
                  </div>
    ...
    function weekly(result) {
      ...
      var options = {
        ...
        data: [{
          // Change type to "doughnut", "line", "splineArea", etc.
          type: "column",
          dataPoints: [{"x":0,"y":185},{"x":1,"y":267},{"x":2,"y":272},{"x":3,"y":280},{"x":4,"y":268},{"x":5,"y":366},{"x":6,"y":364},{"x":7,"y":362},{"x":8,"y":360},{"x":9,"y":358},{"x":10,"y":356},{"x":11,"y":354},{"x":12,"y":352},{"x":13,"y":350},{"x":14,"y":348},{"x":15,"y":406},{"x":16,"y":144},{"x":17,"y":242},{"x":18,"y":340},{"x":19,"y":438},{"x":20,"y":536},{"x":21,"y":634},{"x":22,"y":732},{"x":23,"y":430},{"x":24,"y":428},{"x":25,"y":526},{"x":26,"y":124},{"x":27,"y":222},{"x":28,"y":320},{"x":29,"y":418},{"x":30,"y":516},{"x":31,"y":514},{"x":32,"y":512},{"x":33,"y":510},{"x":34,"y":508},{"x":35,"y":606},{"x":36,"y":104},{"x":37,"y":202},{"x":38,"y":300},{"x":39,"y":398},{"x":40,"y":496},{"x":41,"y":594},{"x":42,"y":692},{"x":43,"y":690},{"x":44,"y":688},{"x":45,"y":986},{"x":46,"y":784},{"x":47,"y":182},{"x":48,"y":780},{"x":49,"y":738},{"x":50,"y":776},{"x":51,"y":574},{"x":52,"y":326}]        }]
      };
    ...
    function weekly2(result) {
      ...
      var options = {
        ...
        data: [{
          // Change type to "doughnut", "line", "splineArea", etc.
          type: "column",
          dataPoints: [{"x":0,"y":0},{"x":1,"y":0},{"x":2,"y":0},{"x":3,"y":0},{"x":4,"y":125}]        }]
      };
    ...
    function weekly3(result) {
      ...
      var options = {
        ...
        data: [{
          // Change type to "doughnut", "line", "splineArea", etc.
          type: "column",
          dataPoints: [{"x":0,"y":0},{"x":1,"y":0},{"x":2,"y":0},{"x":3,"y":0},{"x":4,"y":0},{"x":5,"y":0},{"x":6,"y":0},{"x":7,"y":0},{"x":8,"y":0},{"x":9,"y":0},{"x":10,"y":0},{"x":11,"y":0},{"x":12,"y":0},{"x":13,"y":0},{"x":14,"y":0},{"x":15,"y":0},{"x":16,"y":0},{"x":17,"y":0},{"x":18,"y":0},{"x":19,"y":0},{"x":20,"y":0},{"x":21,"y":0},{"x":22,"y":0},{"x":23,"y":44},{"x":24,"y":51},{"x":25,"y":0},{"x":26,"y":0},{"x":27,"y":30},{"x":28,"y":0},{"x":29,"y":0},{"x":30,"y":0},{"x":31,"y":0}]        }]
      };
